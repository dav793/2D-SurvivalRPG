...
public class GameController : MonoBehaviour {
    ...
    void Start() {
		...
		cells [3, 3].getRenderData ().addSprite ("grass_med_border_0", 2);
		cells [3, 4].getRenderData ().addSprite ("grass_med_border_4", 2);
		cells [3, 5].getRenderData ().addSprite ("grass_med_border_4", 2);
		cells [3, 6].getRenderData ().addSprite ("grass_med_border_3", 2);
		cells [4, 6].getRenderData ().addSprite ("grass_med_border_7", 2);
		cells [5, 6].getRenderData ().addSprite ("grass_med_border_7", 2);
		cells [6, 6].getRenderData ().addSprite ("grass_med_border_2", 2);
		cells [6, 5].getRenderData ().addSprite ("grass_med_border_6", 2);
		cells [6, 4].getRenderData ().addSprite ("grass_med_border_6", 2);
		cells [6, 3].getRenderData ().addSprite ("grass_med_border_1", 2);
		cells [5, 3].getRenderData ().addSprite ("grass_med_border_5", 2);
		cells [4, 3].getRenderData ().addSprite ("grass_med_border_5", 2);


		cells [5, 5].getRenderData ().addSprite ("grass_tall_base_0", 3);

		cells [4, 4].getRenderData ().addSprite ("grass_tall_border_0", 3);
		cells [4, 5].getRenderData ().addSprite ("grass_tall_border_4", 3);
		cells [4, 6].getRenderData ().addSprite ("grass_tall_border_3", 3);
		cells [5, 6].getRenderData ().addSprite ("grass_tall_border_7", 3);
		cells [6, 6].getRenderData ().addSprite ("grass_tall_border_2", 3);
		cells [6, 5].getRenderData ().addSprite ("grass_tall_border_6", 3);
		cells [6, 4].getRenderData ().addSprite ("grass_tall_border_1", 3);
		cells [5, 4].getRenderData ().addSprite ("grass_tall_border_5", 3);
